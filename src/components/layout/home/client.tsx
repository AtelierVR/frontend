    ...
    <HeaderNavigationMenu transparentMode={nav.transparentMode}>
      ...
      <ul className="flex flex-row items-center ms-auto -me-1.5 lg:hidden">
        ...
        <NavigationMenuItem>
          ...
          >
            <Icon icon="material-symbols:keyboard-arrow-down-rounded" className="transition-transform duration-300 group-data-[state=open]:rotate-180" />
          </NavigationMenuTrigger>
            ...
            <div className="-ms-1.5 flex flex-row items-center gap-2 max-sm:mt-2">
              ...
              {i18n && (
                <LanguageToggle>
                  <Icon icon="material-symbols:translate-rounded" className="size-5" />
                  <LanguageToggleText />
                  <Icon icon="material-symbols:keyboard-arrow-down-rounded" className="size-3 text-fd-muted-foreground" />
                </LanguageToggle>
              )}
              {themeSwitch.enabled !== false &&
                (themeSwitch.component ?? <ThemeToggle mode={themeSwitch?.mode} />)}
